...
*shap.ipynb*: produces the SHAP analysis of the covariates.
...
*player_appearance_pass*: dataset with passing data.

*player_appearance_behaviour_under_pressure*: dataset with behavipur under pressure.
